...
class AvailableColorsWidget extends InheritedModel<AvailableColors> {
  final MaterialColor color1; // these are our states
  ...
  Widget build(BuildContext context) {
    switch (color) {
      case AvailableColors.one:
        devtools.log('Color1 Widget got rebuil!');
        break;
      case AvailableColors.two:
        devtools.log('Color2 Widget got rebuil!');
        break;
    }
...
extension RandomElement<T> on Iterable<T> {
  // an extension help us to get random value from Iterable
